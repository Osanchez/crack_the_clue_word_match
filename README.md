...
left matches: ['ROLL']
right matches: ['SHARK', 'SILK', 'VIAL', 'ALKHARID', 'SILVAREA']
left/right matches: []
...
right matches: ['POLE', 'POT', 'ROPE', 'TETRA', 'TILE', 'TINORE', 'TREETOP']
left/right matches: []
...
left matches: ['IRONAXE', 'KNIFE', 'ROLL', 'SILK', 'STAFF', 'STAKE', 'TIARA', 'TILE', 'TINORE', 'ENTRANA']
right matches: ['NEEDLE', 'TUNA', 'UNGAEL']
left/right matches: []
...
left matches: ['CHEESE', 'TORCH']
right matches: ['CLAY', 'COAL', 'CRANDORMAP', 'JAM', 'LAMP', 'MOP', 'RAWSALMON', 'SALMON', 'WOOL', 'CRANDOR']
left/right matches: []

('TASEWNHEVGRANOKNOT', 'SHTOELHTICUTMLHOIO')
left matches: ['EASTER', 'EASTERHAT', 'EEK', 'GRAVESTONE', 'SHARK', 'STAKE', 'TETRA', 'ENTRANA']
right matches: ['CHISEL', 'TILE']
left/right matches: []
```
